...
/*
:- module(acgi).
:- export([cgiExpandChars/2, cgiSend/1, cgiSendLocalHTMLFile/1, cgSendURL/1,
   cgiAskField/5, cgiAskYesNo/3, cgiAskMenu/5, cgiAskTextbox/4, cgiLog/1,
   cgiLogSuspend/0]).
:- end_module(acgi).
